...
class Index:
    ...
    def list_all_person_and_delete_by_table_name(self)->None:
        st.markdown(" <br> " * 5,unsafe_allow_html=True)
    ...
    def sidebar(self)->None:
        ...
        with st.sidebar:
            with st.container(horizontal=True,horizontal_alignment="left") as user_info_sidebar:
            ...
            with st.container(horizontal=True, horizontal_alignment="center") as delete_and_list:
                ...
                user_role = st.selectbox(
                    "List and Delete Users",["","Member","Stuff"],index=["","Member","Stuff"].index(st.session_state.user_role_select_for_delete_and_list),
                ...
                if st.session_state.user_role_select_for_delete_and_list != "":
                    ...
                    if st.session_state.user_role_select_for_delete_and_list.lower() == "member":
...
if __name__ == "__main__":
    ...
    if st.session_state.list_user:
         app.list_all_person_and_delete_by_table_name() 
